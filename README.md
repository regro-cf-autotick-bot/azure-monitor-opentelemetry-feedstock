...
pixi add azure-monitor-opentelemetry
# for installing globally
pixi global install azure-monitor-opentelemetry
```
...
It is possible to list all of the versions of `azure-monitor-opentelemetry` available on your platform:
...
```
pixi search azure-monitor-opentelemetry --channel conda-forge
```
